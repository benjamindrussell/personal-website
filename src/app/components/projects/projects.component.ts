    ...
    projects: Project[] = [
        {
            ...
            heading: "A mobile app designed to keep developers consistent in building side projects by associating the health of digital companions to their GitHub activity",
            descriptions: [
        ...
        },
        {
            ...
            heading: "An app for the Flipper Zero that lets you control Spotify playback when paired with an ESP32",
            descriptions: [
        ...
        },
        {
            ...
            title: "Hue It Is",
            medium: "https://medium.com/99p-labs/reflecting-on-2023-hack-ohi-o-11-b053bde1ee7a",
            github: "https://github.com/gitJhim/hackohio2023",
            heading: "A web app that uses computer vision to simplify indoor navigation",
            descriptions: [
